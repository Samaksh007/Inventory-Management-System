...
app.get("/index",function(req,res){
    res.render(__dirname+"/index.html",{list : {}})
})
...
app.post("/datadelete",function(req,res){
    ...
    const queries = "use dbms; delete from data where lname = '"+req.body.delete+"'"
     connection.query( queries,function(error,result){
        if(error){
            console.log('error in query');
            console.log(queries)
...
app.post("/invadd",function(req,res){
    ...
    const queries = "use inverntorydb; INSERT INTO stocks(stock_id,stock_type, stock_desc)VALUES('"+ newinvid+"','"+newdetailinvtype +"','"+ newdetaildetailinfo+"')";
...
app.post("/invshow",function(req,res){
    ...
    const queries = "use inverntorydb; select * from stocks where stock_type = '"+newdetailinvtype+"' ";
...
app.post("/invdelete",function(req,res){
    ...
    const queries = "use inverntorydb; delete from stocks where stock_id = '"+req.body.delete+"'"
     connection.query( queries,function(error,result){
        if(error){
            console.log('error in query');
            console.log(queries)
...
app.get("/viewcart",function(req,res){
    ...
    console.log(cusname);
    console.log(cus_id);
    const queries = "use dbms; select stocks.stock_id,stocks.stock_type,stocks.stock_desc from stocks,carts where stocks.stock_id=(select carts.stock_id where carts.customer_id="+ cus_id +");"
...
app.post("/placeorder",function(req,res){
    ...
    console.log(cusname);
    console.log(cus_id);
    const queries = "use dbms;INSERT INTO orders(stock_id,customer_id) select stock_id,customer_id from carts where customer_id = "+ cus_id+"; delete from carts where customer_id = "+ cus_id+" ";
    connection.query( queries,function(error,result){
        if(error){
            console.log('error in query');
            console.log(queries);
